...
-- ---------------------------------------------------------------------
-- 3. Trigeri: updated_at un izdarīšanas laikspiedols
-- ---------------------------------------------------------------------
...
begin
  ...
  -- Uzdevums tikko atzīmēts kā izdarīts → ieliekam izdarīšanas laiku.
  ...
  -- Uzdevums atjaunots par aktīvu → laiku noņemam.
