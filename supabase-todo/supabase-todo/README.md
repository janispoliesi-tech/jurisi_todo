...
- **Kategorijas pievieno pats.** Nosaukums, ikona (~130 ikonas ar meklēšanu) un
  krāsa. Kategoriju var pārsaukt un izdzēst; uzdevumi pie tam netiek zaudēti.
- **Arhīvs.** Atzīmētie uzdevumi pazūd no saraksta un nonāk sadaļā «Arhīvs», kur
  tos var atjaunot vai izdzēst pavisam.
...
Arhīvs nav atsevišķa tabula: arhivēts uzdevums ir tāds, kuram `done = true`.
